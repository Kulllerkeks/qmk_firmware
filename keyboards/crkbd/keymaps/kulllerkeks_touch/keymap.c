...
#define _LayerNumb 4
#define _LayerGame 5
#define _LayerGame2 6
#define _LayerMouse 7
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
     TO(_LayerGame), TO(_LayerMod),  KC_NO,  KC_NO,  KC_NO,  DE_PERC,                   DE_PLUS,   KC_7,   KC_8,   KC_9,   DE_ASTR,   KC_NUM,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_NO,    KC_NO,     KC_NO,  KC_NO,  DE_SS,  KC_NO,                       DE_MINS,   KC_4,   KC_5,   KC_6,   DE_SLSH,   DE_DOT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      TO(_LayerBase),    KC_NO,     KC_NO,  KC_NO,  KC_NO,  KC_NO,                       KC_0,      KC_1,   KC_2,   KC_3,   DE_COMM,   DE_EQL,
  //|--------+--------+--------+--------+--------+--------+--------|     |--------+--------+--------+--------+--------+--------+--------|
